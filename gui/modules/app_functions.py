...
class AppFunctions:
    def setThemeHack(self):
        ...
        border-left: 22px solid qlineargradient(spread:pad, x1:0.034, y1:0, x2:0.216, y2:0, stop:0.499 #b0eb2d, stop:0.5 rgba(85, 170, 255, 0));
        ...
        self.ui.commandLinkButton.setStyleSheet("color: #B0EB2C;")